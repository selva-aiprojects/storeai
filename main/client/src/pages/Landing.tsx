...
const trustBadges = [
    ...
    { label: 'Tally XML Sync', color: 'from-blue-600 to-cyan-500' },
    { label: 'ESC/POS Thermal Ready', color: 'from-amber-500 to-orange-500' },
    { label: 'Offline-First Engine', color: 'from-teal-500 to-emerald-500' },
    { label: 'Multi-Tenant SaaS', color: 'from-blue-500 to-indigo-500' },
    { label: 'RBAC Security', color: 'from-rose-500 to-pink-500' },
    { label: 'Multi-MRP & FEFO', color: 'from-purple-500 to-violet-500' },
    { label: 'AI Predictive Engine', color: 'from-violet-500 to-fuchsia-500' },
];
        ...
        features: [
            {
                ...
                title: 'Optech-Standard POS Engine',
                badge: 'F1–F12 Keyboard POS',
                description: 'Mouse-free counter billing with F1–F12 hotkeys, multi-cart hold & resume, cashier shift reconciliation with Z-Reports, and 58mm/80mm raw ESC/POS thermal printing.',
            ...
            },
            {
                ...
                title: 'Multi-MRP & Batch Warehouse',
                badge: 'FEFO Automated',
                description: 'Support multiple MRPs and batches per barcode, granular bin tracking, near-expiry alerts, and automated FEFO/FIFO stock allocation.',
            ...
            },
            {
                ...
                badge: '100% Uptime',
                description: 'Zero counter downtime during network dropouts with local transaction queuing and deterministic background delta synchronization to the cloud.',
        ...
        features: [
            {
                ...
                badge: 'Shared Inventory',
                description: 'Built-in direct-to-consumer digital store sharing real-time synchronized stock with your physical checkout counters.',
            ...
            },
            {
                ...
                badge: 'Credit Ledger',
                description: 'Customer credit ledger (Udhar) with automated WhatsApp statement reminders, payment UPI QR links, and purchase history.',
            ...
            },
            {
                ...
                badge: 'Rewards OS',
                description: 'Tiered reward points, automated comeback coupons, membership tiers, and repeat customer retention triggers.',
        ...
        features: [
            {
                ...
                title: 'Tally Prime & ERP 9 XML Bridge',
                badge: '1-Click Export',
                description: 'Export sales vouchers, daybooks, purchase journals, and tax accounts directly formatted for single-click import into Tally Prime.',
                gradient: 'from-emerald-500/20 to-teal-500/10',
                border: 'border-emerald-500/30',
                glow: 'shadow-emerald-500/20',
                iconColor: 'text-emerald-400',
            ...
            },
            {
                ...
                title: 'Indian GST & GSTR-1 Returns',
                badge: 'Statutory Suite',
                description: 'Automated GSTR-1 government JSON exports, GSTR-3B tax computation, HSN summaries, and CGST/SGST/IGST breakdown.',
            ...
            },
            {
                ...
                badge: 'Auto Salary',
                description: 'Staff attendance tracking, salesperson commission attribution, role permissions, and 1-click monthly salary slip generation.',
