        ...
        <div className="min-h-screen bg-slate-900 text-white font-['Outfit'] overflow-hidden selection:bg-blue-500/30">
            ...
            <nav className="relative z-10 container mx-auto px-6 py-6 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    <img src="/logo-mt.png" alt="StoreAI Logo" className="h-10 w-auto brightness-0 invert opacity-90" />
                </div>
            ...
            <footer className="relative z-10 border-t border-white/10 py-12 bg-slate-950">
                <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                        <img src="/logo-mt.png" alt="StoreAI Logo" className="h-6 w-auto brightness-0 invert opacity-50" />
                    </div>
