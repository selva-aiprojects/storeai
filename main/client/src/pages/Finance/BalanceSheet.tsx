...
const BalanceSheet = () => {
    ...
    return (
        <div className="reporting-container space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-sky-600 text-white p-6 rounded-2xl shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-blue-100 text-sm mt-1 font-medium">Consolidated Statement of Financial Position</p>
                    </div>
                    <div className="text-right">
                        <div className="text-[10px] uppercase font-bold tracking-widest text-blue-200">Total Assets Value</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Equity Column (Finance/blue Theme) */}
                <div className="card border-t-4 border-t-blue-500 bg-white shadow-sm hover:shadow-md transition-shadow">
                    <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-blue-50/30">
                        ...
                        <span className="text-xs font-bold text-blue-600 bg-blue-100 px-2 py-1 rounded-full">Ownership</span>
                    </div>
                    <div className="p-5 space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-dashed border-gray-100">
                        ...
                        <div className="pt-4 flex justify-between items-center text-gray-900 border-t border-gray-100 mt-2">
                            ...
                            <span className="font-black text-lg text-blue-600">{formatCurrency(equity?.total || 0)}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white border border-blue-100 p-6 rounded-2xl flex items-center justify-between shadow-sm relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    <div>
                        <div className="text-blue-900 font-bold text-lg">Accounting Equation Audit</div>
                        <div className="text-blue-600 text-sm font-medium">Assets = Liabilities + Equity Check</div>
                    </div>
                </div>
