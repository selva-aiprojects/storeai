...
const Sidebar = ({ user, logout, mobileOpen, setMobileOpen, isCollapsed, setIsCollapsed }: any) => {
    ...
    const menuItems: any[] = [
        { path: '/', label: 'Executive Dashboard', icon: LayoutDashboard, permission: 'dashboard:view' },
        { divider: 'Omnichannel Touchpoints' },
        { path: '/pos', label: 'In-Store POS Billing', icon: CreditCard, feature: 'RETAIL_MODULE' },
        { path: '/storefront', label: 'Online Web E-Store', icon: Package, feature: 'RETAIL_MODULE' },
        { path: '/customer-portal', label: 'Customer Account Portal', icon: Home, feature: 'CRM_MODULE' },
        { path: '/vendor-portal', label: 'Supplier Portal', icon: Truck, feature: 'PROCUREMENT_MODULE' },
        { divider: 'Inventory & Warehouse' },
        { path: '/products', label: 'Product & SKU Catalog', icon: Layers, feature: 'RETAIL_MODULE', permission: 'inventory:read' },
        ...
        { divider: 'Procurement & Vendors' },
        { path: '/purchases', label: 'Procurement & POs', icon: Truck, feature: 'PROCUREMENT_MODULE', permission: 'orders:read' },
        { path: '/partners', label: 'Supplier Directory', icon: Building2, feature: 'PARTNER_MODULE', permission: 'crm:read' },
        { path: '/customers', label: 'Customer Directory', icon: Home, feature: 'CRM_MODULE', permission: 'crm:read' },
        { divider: 'Workforce & HR' },
        { path: '/hr-master', label: 'Employee Master', icon: Landmark, feature: 'HR_MODULE', permission: 'hr:read' },
        { path: '/attendance', label: 'Shift Attendance', icon: Users, feature: 'HR_MODULE', permission: 'hr:read' },
        { path: '/payroll', label: 'Payroll Engine', icon: Wallet, feature: 'HR_MODULE', permission: 'hr:read' },
        { path: '/hr-reports', label: 'HR Compliance Reports', icon: ShieldCheck, feature: 'HR_MODULE', permission: 'hr:read' },
        { divider: 'Finance & Accounting' },
        { path: '/accounts', label: 'Finance Overview', icon: Landmark, feature: 'FINANCE_MODULE', permission: 'accounts:read' },
        { path: '/daybook', label: 'Daily Daybook', icon: History, feature: 'FINANCE_MODULE', permission: 'accounts:read' },
        ...
        { path: '/liability', label: 'Vendor Liabilities', icon: Receipt, feature: 'FINANCE_MODULE', permission: 'accounts:read' },
        ...
        { path: '/config-finance', label: 'Finance Settings', icon: Settings, feature: 'FINANCE_MODULE', permission: 'accounts:read' },
        { path: '/reports', label: 'Executive Reports', icon: TrendingUp, feature: 'REPORT_MODULE', permission: 'reports:view', hideMobileLabel: true },
        { divider: 'AI Assistant' },
        { path: '/assistant', label: 'StoreAI Copilot', icon: Layers, feature: 'AI_MODULE', permission: 'dashboard:view', hideMobileLabel: true }
    ];
